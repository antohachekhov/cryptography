...
namespace PSZI_lr1_v2
{
    ...
    { 
        ...
        {
            byte[] byteArrayToUlong = new byte[byteCountLong];
        ...
        {
            return ByteArrayToUlong(BitArrayToByteArray(bitArray));
        }

        public static BitArray UlongToBitArray(ulong number)
        {
            return ByteArrayToBitArray(UlongToByteArray(number));
        }
