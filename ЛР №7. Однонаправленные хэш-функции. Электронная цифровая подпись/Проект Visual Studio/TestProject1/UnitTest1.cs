...
namespace TestProject1
{
    public class Tests
    {
        ...
        {
            keysRSA keys = GeneratorKeysRSA.generateKeys(7, 17);

            keysRSA expectedKeys = new keysRSA(5, 77, 119);
        ...
        [Test]
        public void getInverseElem()
        {
            BigInteger d = 9;
            BigInteger f = 10;
            BigInteger expectedNum = 9;
            BigInteger actualNum = EncryptByElgamal.getInverseElem(d, f);
            Assert.AreEqual(expectedNum, actualNum);
        }

        [Test]
        public void GenerateEDSElgamal()
        {
            BigInteger p = 11;
            BigInteger g = 2;
            BigInteger x = 8;
            ...
            (BigInteger, BigInteger) expectedNum = (6, 3);
            (BigInteger, BigInteger) actualNum = eds.eds;
            Assert.AreEqual(expectedNum, actualNum);
        }
    }
}