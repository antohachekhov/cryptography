...
namespace TestProject1
{
    public class Tests
    {
        ...
        {
            BitArray key = new BitArray(GeneratorDESKey.keyLength);
            GeneratorDESKey generatorKey = new GeneratorDESKey(key);
        ...
        public void ExtendedKeyOdd()
        {
            ...
            BitArray newKey = GeneratorDESKey.ExtendedKey(key);
        ...
        public void DivideKeyToC0()
        {
            ...
            GeneratorDESKey generatorKey = new GeneratorDESKey(new BitArray(56));
            GeneratorDESKey.DivideKeyToC0AndD0(generatorKey, key);
        ...
        [Test]
        public void GeneratorKeysRSAgenerateKeys()
        {
            keys keys = GeneratorKeysRSA.generateKeys(7, 17);

            keys expectedKeys = new keys(5, 77, 119);
            
            Assert.AreEqual(expectedKeys, keys);
        }

        [Test]
        public void EncrypteWithDecrypteRSA()
        {
            keys keys = new keys(5, 77, 119);

            bool[] textBool = { true, true, false, false, true, false, false, false,
                                false, false, false, false, false ,false , false, false,
                                true, true, true, true, true, true, true, true,
                                false, false, false, false, false ,false , false, false,
                                true, true, true, true, true, true, true, true,
            ...
            BitArray cipherText = EncryptByRSA.Encrypte(text, keys.openKey);
            BitArray originalText = EncryptByRSA.Decrypte(cipherText, keys.closeKey);
            CollectionAssert.AreEqual(text, originalText);
        }

        [Test]
        public void EncrypteWithDecrypteRSA2()
        {
            keys keys = GeneratorKeysRSA.generateKeys(3, 37);
        ...
        public void BitArrayToBigInteger()
        {
            ...
            bool[] textBool = { true, true, true, true, true, true };

            BitArray text = new BitArray(textBool);

            BigInteger expectedNum = 63;
            BigInteger actualNum = EncoderClass.BitArrayToBigInteger(text);
